...
def generate_launch_description():
    ...
    package_name = 'easybot_description'
    ...
    rviz_config_file = os.path.join(get_package_share_directory('easybot_description'),'config','easybot.rviz')
    # Create an RViz node
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
    ...
    ld.add_action(DeclareLaunchArgument(
        'use_sim_time',
        default_value='false',
        description='easybot_description'))
